...
import { volume_1_issue_1_jouranl_list_data } from "../../../../Utils/JournalsData/2024/volume-1-issue-1/valume-1-issue-1-data";
    ...
    <>
      <div className="volumeIssue_container">
        ...
        <div className="volumeIssue_pdf_container">
          {volume_1_issue_1_jouranl_list_data.map((element, index) => (
            <PdfViewer
              key={index}
              element={element}
            />
