export const volume_2_issue_1_jouranal_list_data = [
    {
        index: 1,
        message: "A Review on Harnessing Large Language Models to Transform Conversational Information Retrieval",
...
CIR System relied on rule-based approaches and rigid query structures.`,
    ...
    {
        index: 2,
        message: "Assessment of Antioxidant Activity and Phytochemical Composition in Brassica nigra L. and Brassica oleracea var. Botrytis Microgreens",
...
`
    ...
    {
        index: 3,
        message: "A Review paper of Comparative analysis of a T shaped structure considering viscous dampers with general framed structure under seismic load using analysis tool",
...
`
    ...
    {
        index: 4,
        message: "Staphylococcus Epidermidis: Friend Or FOE: A Commensal Bacterium but Highly Opportunistic Pathogen: A Review",
        author: "1. Dr. Reena Kulshrestha, 2. Mrs. Pooja Sitholay, 3. Ms. Sangita Roy",
...
challenges it poses in clinical environments. `
    ...
    {
        index: 5,
        message: "Analysis of a Circular Water Tank Considering Lateral Load Using Analysis Tool",
...
software, to model and analyze a circular water tank, evaluating its response to various loading conditions.`
    ...
    {
        index: 6,
        message: "Formulation and Evaluation of Herbal Extract Sublingual Tablet for Peanut Allergy",
...
`
    ...
    {
        index: 7,
        message: "The Role of Innovative Financial Inclusion Technologies in Economic Development of India",
...
`
    ...
    {
        index: 9,
        message: "Performance Appraisal of Faculty Members in Higher Educational Institutions: A Study",
...
`
    ...
    {
        index: 10,
        message: "In-vitro Release Study of Diacerein Loaded Microemulsion-Based Hydrogels in the Treatment of Osteoarthritis",
        author: "1. Suchita Wamankar, 2. Tilotma Sahu, 3. Gyanesh Kumar Sahu, 4. Rajesh Kumar Nema",
...
site by applying a microemulsion-based hydrogel system and at the same time reduce the risk of adverse drug-related effects.`
    },
    {
        ...
        author: "1. Dr. Akanksha Raut, 2. Dr. Karthik Krishna M., 3. Dr. Nidhi Adyalkar, 4. Dr. Mayank Jain",
