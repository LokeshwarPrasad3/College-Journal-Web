  ...
  return (
    <>
      <div className="max_width_content_page px-5 flex flex-col justify-start items-start gap-2 text-justify py-8 ">
        <h1 className="text-2xl font-bold">Peer Review Policy</h1>
        <b className="text-xl font-bold">Duties of Authors</b>
        <p className="flex flex-col gap-0 justify-start items-start">
        ...
        <p className="flex flex-col gap-0 mt-1 justify-start items-start">
        ...
        <p className="flex flex-col gap-0 mt-1 justify-start items-start">
          <b className="text-xl mb-1 font-bold">Duties of Reviewers</b>
        ...
        <p className="flex flex-col gap-0 mt-1 justify-start items-start">
          <b className="text-xl mb-1 font-bold"> Duties of Editors </b>
        ...
        <p className="flex flex-col gap-0 mt-1 justify-start items-start">
          <b className="text-xl mb-1 font-bold"> Duties of the Publisher </b>
        ...
        <p className="flex flex-col gap-0 mt-1 justify-start items-start">
          <b> conflict of interest </b>A conflict of interest can occur when you
          (or your employer or sponsor) have a financial, commercial, legal, or
          professional relationship with other organizations, or with the people
          working with them, that could influence your research. Full disclosure
          is required when you submit your paper to a journal. The journal
          editor will firstly use this information to inform his or her
          editorial decisions. They may then publish such disclosures to assist
          readers in evaluating the article. Or, instead, the editor may decide
          not to publish your article on the basis of any declared conflict. You
          can declare the conflict of interest on your cover letter or on the
          manuscript submission form in the journals online peer-review system.
        </p>
        <p className="flex flex-col gap-0 mt-1 justify-start items-start">
